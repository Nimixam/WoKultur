...
<template>
  <div
    class="container mx-auto px-4 min-h-screen bg-white dark:bg-gray-900 text-black dark:text-white"
  >
    ...
    <div class="flex items-center justify-between mt-4 space-x-4">
      ...
      <div class="flex items-center gap-2">
        <input
          type="checkbox"
          id="stadtkoeln-toggle"
          v-model="showCologneEvents"
          class="mr-1 cursor-pointer"
        />
        <label for="stadtkoeln-toggle" class="text-sm font-medium">
          Events (Stadt Köln)
        </label>
        <input
          type="checkbox"
          id="ticketmaster-toggle"
          v-model="showTicketmasterEvents"
          class="mr-1 cursor-pointer"
        />
        <label for="ticketmaster-toggle" class="text-sm font-medium">
        ...
        <input
          ...
          class="mr-1 cursor-pointer"
        />
        <label for="sights-toggle" class="text-sm font-medium">
          Sehenswürdigkeiten
        </label>
        <input
          type="checkbox"
          ...
          class="mr-1 cursor-pointer"
        />
        <label for="heatmap-toggle" class="text-sm font-medium">
          Heatmap
        </label>
      </div>
