    ...
    <div class="w-full px-4">
      ...
      <div class="mb-4">
        ...
        <input
          ...
          min="1"
          max="90"
          v-model.number="localDaysToFilter"
      ...
      <div class="flex justify-center mb-4">
        <button
          class="px-2 py-1 text-sm bg-gray-600 text-white rounded hover:bg-gray-700 focus:outline-none"
          @click="resetFilter"
        >
          Filter zurücksetzen
        </button>
...
watch([localDaysToFilter, localSelectedCategory], ([newDays, newCategory]) => {
